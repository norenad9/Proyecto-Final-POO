...
func _conectar_computadores():
	var computers = {
		computer: "res://easy_1.tscn",
		computer2: "res://easy_2.tscn",
		computer3: "res://easy_3.tscn",
		computer4: "res://easy_4.tscn",
		computer5: "res://easy_5.tscn"
	}
...
func mostrar_ventana_game_over():
	...
	var game_over_scene = load("res://game_over_window.tscn")
...
func mostrar_ventana_victoria():
	...
	var win_scene = load("res://you_win_window.tscn")
	if win_scene == null:
...
func create_game_over_window() -> Control:
	...
	var script = load("res://game_over_window.gd")
	if script:
...
func create_win_window() -> Control:
	var window = Control.new()
	var script = load("res://you_win_window.gd")
	if script:
		window.set_script(script)
	return window
