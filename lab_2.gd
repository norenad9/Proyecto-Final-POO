...
@onready var computer = $Computer18
@onready var computer2 = $Computer6
@onready var computer3 = $Computer7
@onready var computer4 = $Computer8
@onready var computer5 = $Computer9
...
func _ready():
	...
	configurar_jugador()
	player.connect("player_dead", Callable(self, "mostrar_ventana_game_over"))
...
func _conectar_computadores():
	var computers = {
		computer: "res://medi_6.tscn",
		computer2: "res://medi_7.tscn",
		computer3: "res://medi_8.tscn",
		computer4: "res://medi_9.tscn",
		computer5: "res://medi_10.tscn"
	}
...
func configurar_jugador():
	...
	if game_manager and game_manager.has_method("get"):
		...
		print("⚠️ GameManager no encontrado, usando personaje por defecto")
...
func mostrar_ventana_game_over():
	...
	var game_over_scene = load("res://game_over_window_2.tscn")
...
func mostrar_ventana_victoria():
	...
	var win_scene = load("res://you_win_window_2.tscn")
	if win_scene == null:
...
func create_game_over_window() -> Control:
	...
	var script = load("res://game_over_window_2.gd")
	if script:
...
func create_win_window() -> Control:
	var window = Control.new()
	var script = load("res://you_win_window_2.gd")
	if script:
		window.set_script(script)
	return window
