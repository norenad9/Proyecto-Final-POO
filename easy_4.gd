...
# Variables del juego
var sequence = []  # Los 3 colores a presionar
...
func create_timer_panel():
	...
	timer_label.text = "TIEMPO: 10 segundos"
...
func create_sequence_panel():
	...
	seq_title.text = "MEMORIZA ESTOS 3 CÓDIGOS:"
	...
	sequence_display.position = Vector2(200, 50)
